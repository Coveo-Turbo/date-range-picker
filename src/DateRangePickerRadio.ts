...
import l = Coveo.l;
import { IRadioSelectEventArgs, DateRangePickerEvent } from './events/DateRangePickerEvents';

export interface IDateRangePickerRadioOptions {
  todayCaption?: string;
 ...
 *
 * @export
 * @class DateRangePickerRadio
 */
export class DateRangePickerRadio {
  ...
  constructor(private root: HTMLElement, private options: IDateRangePickerRadioOptions) {}
  ...
  build(): HTMLElement {
    ...
    this.radioOptions = [
      this.buildRadioButton(DateRangePickerRadio.TODAY, this.options.todayCaption || l(DateRangePickerRadio.TODAY)),
      this.buildRadioButton(DateRangePickerRadio.THIS_WEEK, this.options.thisWeekCaption || l(DateRangePickerRadio.THIS_WEEK)),
      this.buildRadioButton(DateRangePickerRadio.LAST_WEEK, this.options.lastWeekCaption || l(DateRangePickerRadio.LAST_WEEK)),
      this.buildRadioButton(DateRangePickerRadio.THIS_MONTH, this.options.thisMonthCaption || l(DateRangePickerRadio.THIS_MONTH))
    ];
  ...
  private onRadioChange(radioOption: RadioOption) {
    ...
    $$(this.root).trigger(DateRangePickerEvent.radioSelect, args);
  }
